...
public class DateDifference {
    ...
    private void getInput(){
        String d1 = inputValidator("^(3[01]|[12][0-9]|0[1-9])/(1[0-2]|0[1-9])/[0-9]{4}$");
        String d2 = inputValidator("^(3[01]|[12][0-9]|0[1-9])/(1[0-2]|0[1-9])/[0-9]{4}$");
        ...
        System.out.println("\n\nDifference between two dates are " +getDifference(date1,date2) );
    }
    private String inputValidator(String regex) {
